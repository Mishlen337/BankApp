...
class ChangeSettings(QtWidgets.QDialog):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ApplyDesignPushButton.clicked.connect(self.OnApplyDesignPushButton)
    ...
    def OnBackPushButton(self):
        ...
        Остановка показа формы изменения настроек и переход к форме выбора настроек.
        """   
        self.reject()
    ...
    def OnApplyDesignPushButton(self):
        """
        Обработка события нажатия на кнопку "Применить новый дизайн приложения".
