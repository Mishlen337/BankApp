...
def bank_query(bank: str, start_date: str, end_date: str)->list:
    ...
    сортированный по времени список с датами, названием банка и коэффициентами из витрины данных.
    """
    #Подсоединение к бд
    ...
    with engine.connect() as conn:
        #Формирует витрину
        form_bank.form_bank_mart(engine, conn, meta, bank, start_date, end_date)
...
def bank_list_query(bank_list: list, b_date: str):
    ...
    with engine.connect() as conn:
        #Формирует витрину
        form_bank_list.form_bank_list_mart(engine, conn, meta, bank_list, b_date)
        #Берет из витрины дынные
